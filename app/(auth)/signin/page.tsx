        ...
        <div className="hidden lg:flex lg:w-1/2 bg-brand-primary-dark items-center justify-center p-12">
          <div className="text-center">
            ...
            <div className="w-[280px] h-[280px] mx-auto mb-8">
              <Image
                src="/doodles/MeditatingDoodle.svg"
                alt=""
                width={280}
                height={280}
            ...
            <p className="text-white/80 text-lg">We've sent you a reset link</p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
          <div className="max-w-md w-full space-y-8">
            <div className="text-center lg:text-left">
              <div className="mx-auto lg:mx-0 h-12 w-12 flex items-center justify-center rounded-full bg-brand-primary-dark/10 mb-4">
                <svg
                  className="h-6 w-6 text-brand-primary-dark"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-brand-primary-dark items-center justify-center p-12 overflow-hidden">
        <div className="text-center">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4">Ready to listen again?</h2>
            <p className="text-white/80 text-lg">Your documents are waiting for you</p>
          </motion.div>
        </div>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSignIn}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-primary-dark focus:border-brand-primary-dark"
            ...
            <div className="flex items-center justify-end">
              <button
                ...
                className="text-sm font-medium text-brand-primary-dark hover:text-brand-primary-dark/80 transition-colors"
              >
                Forgot password?
              </button>
            </div>
